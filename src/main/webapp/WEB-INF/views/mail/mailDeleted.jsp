			...
			<div align="right">
				<div class="ctheader">
					<div class="input-append">
						<input class="span2" type="text" id="deletedKeywords" name="deletedKeywords">
				...
				<tbody>
				 <c:forEach items="${sysMailsList.content}" var="mailBox">
					<tr style="cursor: pointer;">
						...
						<td onclick="parent.openNewTab('De'+${mailBox.id},'${mailBox.title}','${ctx}/mail/detail/${mailBox.id}/2');" ><div class="txtflow">${mailBox.title}</div></td>
						<td>${mailBox.deletetime}</td>
					</tr>
				 </c:forEach>
				</tbody>
			</table>
...
function doSearch()
{
	var keywords=$("#deletedKeywords").val();
	keywords=encodeURIComponent(keywords,"UTF-8");
	parent.openNewTab('14','已删除','${ctx}/mail/mailmng/3?keyword='+encodeURIComponent(keywords,"UTF-8"));
}
