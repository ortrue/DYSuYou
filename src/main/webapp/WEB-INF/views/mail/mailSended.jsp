			...
			<div align="right">
				<div class="ctheader">
					<div class="input-append">
						<input class="span2" type="text" id="sendedKeywords" name="sendedKeywords">
				...
				<tbody>
				 <c:forEach items="${sysMailsList.content}" var="mailBox">
					<tr style="cursor: pointer;">
						...
						<td onclick="parent.openNewTab('S'+${mailBox.id},'${mailBox.title}','${ctx}/mail/detail/${mailBox.id}/2');" ><div class="txtflow">${mailBox.title}</div></td>
						<td>${mailBox.sendtime}</td>
					</tr>
				 </c:forEach>
				</tbody>
			</table>
...
function doSearch()
{
	var keywords=$("#sendedKeywords").val();
	keywords=encodeURIComponent(keywords,"UTF-8");
	parent.openNewTab('13','已投递','${ctx}/mail/mailmng/2?keyword='+encodeURIComponent(keywords,"UTF-8"));
}
